...
impl TestSpecs for Block128 {
    const EXPECTED_EMPTY: (u128, u128) = (
        88646692503925743579018970281127781170,
        247959515254010244634307915799020148784,
    );
    const EXPECTED_63: (u128, u128) = (
        164991271583769133590642852274786967594,
        129405523932521234129616695725827350025,
    );
    const EXPECTED_64: (u128, u128) = (
        14234042463690587035412728637870393686,
        169413731930060082897518015784376500524,
    );
    const EXPECTED_65: (u128, u128) = (
        320525361366244192613810020904072394842,
        317514301733478437164362044691147074836,
    );
    const EXPECTED_STRESS: (u128, u128) = (
